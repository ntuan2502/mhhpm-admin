...
import { faFileInvoice, faCaretDown } from '@fortawesome/free-solid-svg-icons';
...
export default function Sidebar() {
	return (
		<div className="bg-[#FF5F5F] h-screen">
			...
			<div className="text-[16px] flex justify-center font-Mulish bg-[#C74A4A] p-4 text-white <div class="box-content h-32 w-32 p-4 border-4 ...">
  <!-- ... -->
</div>">
