...
export default function Sidebar() {
	return (
		<div className="bg-[#FF5F5F] h-screen">
			...
			<div className="text-[16px] flex flex-row font-Mulish bg-[#D85050] p-4 text-black ">
				<div className="flex items-center">
					<FontAwesomeIcon icon={faSpinner} />
				</div>
				<div className="basis-2/4">Pending</div>
			</div>
			<div className="text-[16px] flex font-Mulish p-4 text-black">
				<div className="flex items-center pr-6 w-2/5">
					<FontAwesomeIcon icon={faSpinner} />
				</div>
				<div>Rejcet</div>
			</div>
