...
export default function Sidebar() {
	const [showMeBills, setShowMe1] = useState(false);
	function toggleBills() {
		setShowMe1(!showMeBills);
	}
	const [showMeFoods, setShowMe2] = useState(false);
		...
		<div className="">
			...
			>
				<Link href="/foods/pending">
					<div className="text-[16px] flex font-Mulish hover:bg-[#D85050] bg-[#EB5757] p-4 text-black cursor-pointer">
